...
-- Tab movement
vim.keymap.set('n', '[t', 'gT', { silent = true })
vim.keymap.set('n', ']t', 'gt', { silent = true })

-- Loclist movement
vim.keymap.set('n', '[w', ':lprevious<cr>', { silent = true })
vim.keymap.set('n', ']w', ':lnext<cr>', { silent = true })
...
-- [[ Fugitive ]]
vim.keymap.set("n", "<leader>go", ":G<cr>", { desc = "[G]it [O]pen", silent = true })
...
require('conform').setup({
  ...
  formatters = {
    js_beautify = {
      command = 'js-beautify',
      args = { '-f', '$FILENAME', '--editorconfig', '-a', '-n', 'false' }
    },
    html_beautify = {
      command = 'html-beautify',
      args = { '-f', '$FILENAME', '--editorconfig', '-A', 'force-aligned' }
    },
    css_beautify = {
      command = 'css-beautify',
      args = { '-f', '$FILENAME', '--editorconfig' }
    }
  }
})
...
-- vim.keymap.set('n', '<leader>sg', telescope_grep_string, { desc = '[S]earch by [G]rep' })
vim.keymap.set('n', '<leader>sg', fzf_grep_string, { desc = '[S]earch by [G]rep' })
vim.keymap.set('n', '<leader>sG', require('fzf-lua').live_grep, { desc = '[S]earch by [G]rep on Git Root' })
...
local on_attach = function(_, bufnr)
  ...
  -- nmap('<leader>l', vim.lsp.buf.format, 'Format')
  nmap('<leader>l', require('conform').format, 'Format')
