...
local on_attach = function(client, bufnr)
  ...
  buf_set_keymap('n', '<leader>L', '<cmd>lua vim.diagnostic.reset()<CR>', opts)
...
local servers = { 'html', 'cssls', 'jsonls', 'tsserver', 'csharp_ls' }
...
-- local omnisharp_bin = "/home/royyhlee/omnisharp/run"
